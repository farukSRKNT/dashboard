...
const useStyles = makeStyles((theme) => ({
    drawerPaper: { width: 'inherit', backgroundImage: 'linear-gradient(#4C8DEB, #4C60EB);' },
    link: {
      borderRadius: '5px',
      width: '45px',
      height: '45px',
  ...
  const classes = useStyles();
    ...
    return (
      ...
      >
            ...
            <NavLink to="/users" className={classes.link} activeClassName={classes.activeLink} exact>
                    <Icon>
            ...
            <NavLink to="/feed" className={classes.link} activeClassName={classes.activeLink} exact>
                    <Icon>
                        <img src={FeedIcon} height={25} width={25} alt=""/>
                    </Icon>
            </NavLink>

            <NavLink to="/price" className={classes.link} activeClassName={classes.activeLink} exact>
                    <Icon>
